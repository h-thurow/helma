...
class FunctionObserver extends BaseFunction implements Observer {
     ...
     * 
     */
    private static final long serialVersionUID = 365861101373299071L;
	...
	public Object call(Context cx, Scriptable scope, Scriptable thisObj,
        ...
        if (onChange != null) {
            ...
            if (object instanceof HopObject) {
                ...
                timestamps.add(new Long(((HopObject) object).getNode().lastModified()));
            }
        }
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (onChange != null && arg instanceof HopObject) {
                ...
                timestamps.add(new Long(((HopObject) arg).getNode().lastModified()));
            }
        }
        ...
        if (onChange != null) {
            for (int i = 0, l = objects.size(); i < l; i++) {
                ...
                if (object.getNode().lastModified() != timestamps.get(i).longValue())
